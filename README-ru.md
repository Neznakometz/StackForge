...
Каждый новый проект означает снова устанавливать скилы, снова писать правила, снова собирать процесс. StackForge делает это **одной командой**: тонкое **ядро** ставится всегда, `/init` спрашивает про твой стек и собирает под него `CLAUDE.md`, а **доменный набор** добавляет специализацию.
...
3. Собирает `CLAUDE.md` из выбранных паков; конфликтующие (React ⊥ Vue, Riverpod ⊥ Bloc) никогда не склеиваются — он спрашивает.
